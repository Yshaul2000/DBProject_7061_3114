...
9. [Stage 5 – Graphical User Interface (GUI) for Database Interaction](#stage-5--gui)
   - [db](#db)
   - [login_screen](#login_screen)
   - [main](#main)
   - [student_crud](#student_crud)
   - [payment_crud](#payment_crud)
   - [takes_scholarship_crud](#takes_scholarship_crud)
   - [fetch_all_tables](#fetch_all_tables)
   - [more_option](#more_option)
   - [queries_screen](#queries_screen)
   - [functions_screen](#functions_screen)
   - [procedures_screen](#procedures_screen)
   - [main_programs_screen](#main_programs_screen)
